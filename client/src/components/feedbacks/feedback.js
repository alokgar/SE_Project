...
import { getFeedbacks ,addFeedback,editFeedback,deleteFeedback} from '../../actions/feedback';
...
const onSubmit = async e => {
    ...
    if(showEdit === false)
      addFeedback({ id,subject,content });
    else
     {
...
const onViewclick = id =>{
    viewId===null?setviewId(id):viewId===id?setviewId(null):setviewId(id);
}
...
export default connect(
  mapStateToProps,
  { getFeedbacks, addFeedback,editFeedback,deleteFeedback}
)(Feedback);