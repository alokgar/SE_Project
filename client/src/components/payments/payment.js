...
import { getPayments ,addPayment,editPayment,deletePayment} from '../../actions/payment';
...
const onSubmit = async e => {
    ...
    if(showEdit === false)
      addPayment({ amount,date,customer_id});
    else
     {
...
export default connect(
  mapStateToProps,
  { getPayments, addPayment,editPayment,deletePayment}
)(Payment);