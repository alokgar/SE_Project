            ...
            <Col>
                ...
                >
                    ...
                    <Table striped bordered hover>
                        <thead>
                            <tr><th>Order Date</th><th>Status</th> <th>Dispatch Date</th></tr>
                        </thead>
                        <tbody>
                            ...
                            return (
                                ...
                                <td>
                                    {order.dispatched_date ===undefined?"Not Dispatched":order.dispatched_date.slice(0,10)}
                                    <Button variant="success" style={{float:'right',padding:'2px 4px'}}
                                  onClick={()=>{ viewId===null?setviewId(order._id):viewId===order._id?setviewId(null):setviewId(order._id) }} > 
                                  ˅</Button>
                                </td>
